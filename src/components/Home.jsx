...
const Home = () => {
    return (
        <section
            className='bg-slate-200 align-element grid md:grid-cols-2 items-center gap-8 border-b-2 border-gray-400 py-16'
            id='home'
        >
            <article className=' xs:py-8 mt-5 flex flex-col justify-center sm:ml-10'>
