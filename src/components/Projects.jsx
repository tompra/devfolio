            ...
            <div className='grid grid-cols-1 md:grid-cols-2  xl:grid-cols-3 gap-8'>
                {projects.map((project) => {
                    ...
                    return (
                        <div
                            key={id}
                            className='bg-gray-100 border border-gray-200 rounded-lg my-5 shadow-[12px_12px_0px_0px_rgba(3,105,161)] transition-all duration-300 transform hover:shadow-[0px_0px_0px_0px_rgba(3,105,161)] hover:border-2 hover:border-sky-700'
                        >
                            <img
